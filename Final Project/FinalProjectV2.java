//CSC 200 - Final Project Version 2
...
public class FinalProjectV2 extends JFrame implements KeyListener, Runnable {
	 int screenWidth = 400;
	 ...
	 public void update() {
			  ...
			  if(hamburger.center().getY() < 0) {
			   hamburger.setPosition(new Point(rand.nextInt(390),0));  
				...
				hamburger.setVelocity(new Point(0,rand.nextInt(9)));
				}
			  ...
			  if(apple.center().getY() < 0) {
			   apple.setPosition(new Point(rand.nextInt(390),0));  
				appleVisible = true; 
				apple.setVelocity(new Point(0,rand.nextInt(9)));
				}
			  ...
			  if(chocolate.center().getY() < 0) {
			   chocolate.setPosition(new Point(rand.nextInt(390),0));  
				...
				chocolate.setVelocity(new Point(0,rand.nextInt(9)));
				}
			  ...
			  if(dynamite.center().getY() < 0) {
			   dynamite.setPosition(new Point(rand.nextInt(390),0));  
				...
				dynamite.setVelocity(new Point(0,rand.nextInt(9)));
				}
